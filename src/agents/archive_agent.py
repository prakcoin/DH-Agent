...
from src.tools.archive_tools import get_look_composition, get_collection_summary, get_image_input, get_look_visual_analysis
...
def archive_assistant(query: str) -> str:
    ...
    try:
        ...
        archive_agent = Agent(
            ...
            tools=[get_look_composition, get_collection_summary, get_look_visual_analysis, get_image_input, retrieve],
            plugins=[plugin],
            hooks=[limit_hook]
        )

...
2. Pass the retrieved look images and the query to the second agent, which uses the get_image_details tool to get detailed visual analysis.
3. Finally, pass the visual and knowledge base information to the final agent in order to synthesize a final answer.
